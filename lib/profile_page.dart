// Copy the entire ProfilePage code here (from the code you provided)
// This includes all the classes: ProfilePage, LoginPage, SignUpPage, GoogleSignInApi, and ForgotPasswordPage import 'dart:async';
import 'dart:convert';
import 'dart:async';
